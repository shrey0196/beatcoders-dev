...
# Add showVisualHint function and problemHints data to main.js
...
try:
    ...
    # 1. Add problemHints data at the top
    hints_data = """
    ...
    if 'problemHints' not in content:
        ...
        if "document.addEventListener('DOMContentLoaded'" in content:
            content = content.replace(
                ...
                hints_data + "document.addEventListener('DOMContentLoaded'"
            )
            print("Added problemHints data")
    else:
        print("problemHints already exists")

    # 2. Add showVisualHint function
    hint_function = """
...
"""
    ...
    if 'function showVisualHint' not in content:
        # Add before showFailureScreen
        if 'function showFailureScreen' in content:
            ...
            print("Could not find showFailureScreen")
    else:
